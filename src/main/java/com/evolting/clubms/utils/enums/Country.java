...
public enum Country {
    ...
    CROATIA("HR"),
    CUBA("CU"),
    CURACAO("CW"), // Note: Java enum constants should not contain special characters if possible
    CYPRUS("CY"),
    CZECH_REPUBLIC("CZ"),
    DENMARK("DK"),
    DJIBOUTI("DJ"),
    ...
    // Private constructor to set the code for each enum constant
    ...
    /**
     * Helper method to look up an Enum constant by its ISO code.
     *
     * @param isoCode The 2-letter ISO code to search for.
     * @return The matching Country enum constant, or null if not found.
     */
